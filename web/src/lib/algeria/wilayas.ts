/**
 * الولايات الجزائرية (58 ولاية) — التقسيم الإداري الرسمي.
 * المصدر: التنظيم الإداري للجمهورية الجزائرية (ولايات 1–48 + الولايات الجديدة 49–58).
 */
export type Wilaya = {
  code: string;
  nameAr: string;
...
export const ALGERIA_WILAYAS: Wilaya[] = [
  ...
  { code: '28', nameAr: 'مسيلة', nameFr: "M'Sila" },
...
export function findWilayaByName(name: string): Wilaya | undefined {
  const n = name.trim();
  return ALGERIA_WILAYAS.find((w) => w.nameAr === n || w.nameFr === n);
}
