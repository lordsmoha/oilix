...
export function AppHeader({ title, subtitle, userName, onLogout, onPrintHistory, accent }: Props) {
        ...
        <View style={styles.row}>
          <View style={styles.brand}>
            <View style={styles.logo}>
              <Icon name="nutrition" size={24} color={c.gold} />
            </View>
            <View>
          ...
          <View style={styles.actions}>
            ...
            <ThemeToggle light />
            {onPrintHistory ? (
              <Pressable onPress={onPrintHistory} style={styles.logout} hitSlop={12}>
